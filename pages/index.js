        ...
        <section className="fullscreen">
            ...
            <div className="fullscreen-container">
                <div className="container home">
                    ...
                    <div>
                        <a href="mailto:hello@lucasm.dev?subject=Let's%20work%20together" className="button">Let’s chat</a>
                    </div>
            ...
            <div className="container">
                ...
                <div className="flex-container">
                    ...
                    <div className="grid">
                        ...
                        <a href="https://findto.app" className="card" target="_blank">
                            <figure>
                        ...
                        <a href="#" className="card">
                            ...
                            <p>User interface for a personal finance and investment app.</p>
                        </a>
                        ...
                        {/* <a href="#" className="card">
                            ...
                            <p>Website for a psychotherapy online service.</p>
                        </a>
